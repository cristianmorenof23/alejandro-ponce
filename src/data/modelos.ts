export const modelos = [
...

  {
    ...
    features: [
      ...
      { icon: "FaLightbulb", title: "Faros IQ Light LED" },
      { icon: "FaShieldAlt", title: "Seguridad 6 Airbags + asistentes" },
      { icon: "FaBolt", title: "Conectividad VW Play + Active Info Display" },
    ],
    versiones: [
      {
        nombre: "Comfortline",
        descripcion:
          "Versión de entrada con equipamiento completo, motor 250 TSI y diseño robusto.",
        imagen: "/taos_version_1.webp",
        specs: [
          "Año/Modelo 2025",
          "Motor de gasolina de 4 cilindros 1.4 TSI",
          "Volante multifunción táctil capacitivo en cuero, con levas de cambio",
          "Wired & Wireless App-Connect con GPS (antena sólo para App-Connect)",
          'Climatizador Touch "Air Care Climatronic" con filtro combinado activo y regulación de temperatura de 2 zonas',
          "Digital Cockpit Pro multicolor, permite seleccionar distintos perfiles de información",
          "Tapizado de asientos en vinilo",
          "Sistema Start-Stop con recuperación de la energía de frenado",
          'Cierre centralizado "Keyless-Entry" sin cierre de seguridad',
          "Carga inalámbrica para smartphones",
          'Llantas de aleación ligera 18″',
          "Detector de fatiga",
        ],
      },
      {
        nombre: "Highline",
        descripcion:
          "Versión premium: tecnología superior, faros IQ Light, techo panorámico y confort máximo.",
        imagen: "/taos_version_2.webp",
        specs: [
          "Año/Modelo 2025",
          "Motor de gasolina de 4 cilindros 1.4 TSI",
          "Volante multifunción táctil capacitivo en cuero, con levas de cambio",
          "Wired & Wireless App-Connect con GPS (antena solo para App-Connect)",
          'Climatizador Touch "Air Care Climatronic" con filtro combinado activo y regulación de temperatura de 2 zonas',
          "Digital Cockpit Pro multicolor, permite seleccionar distintos perfiles de información",
          ...
          "Asistente activo para salida de aparcamiento",
          "Sistema de asistencia para mantenimiento de carril",
    ...
    ficha: [
      ...
      { titulo: "Transmisión", detalle: "Automática 6 velocidades" },
      { titulo: "Baúl", detalle: "498 litros" },
      { titulo: "Seguridad", detalle: "6 Airbags + ESC + asistentes de conducción" },
      { titulo: "Faros", detalle: "LED IQ Light + firma lumínica VW" },
    ],
    contacto: {
      whatsapp: "https://wa.me/3515607232",
      instagram: "https://instagram.com/aleponceautohaus",
